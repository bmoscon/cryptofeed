...
class TestGeminiRest:
    ...
    def test_place_order_and_cancel(self):
        order_resp = sandbox.place_order_sync(
            symbol="BTC-USD", side=BUY, order_type=LIMIT, amount="1.0", price="622.13", client_order_id="1"
        )
    ...
    def test_order_status(self):
        order_resp = sandbox.place_order_sync(
            symbol="BTC-USD", side=BUY, order_type=LIMIT, amount="1.0", price="1.13", client_order_id="1"
        )
