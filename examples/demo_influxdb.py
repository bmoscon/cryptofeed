...
def main():
    ...
    f = FeedHandler()
    f.add_feed(Bybit(channels=[FUNDING, L2_BOOK], symbols=['BTC-USDT-PERP'], callbacks={FUNDING: FundingInflux(INFLUX_ADDR, ORG, BUCKET, TOKEN), L2_BOOK: BookInflux(INFLUX_ADDR, ORG, BUCKET, TOKEN)}))
