...
from cryptofeed.exchanges import Bybit, Coinbase
...
def main():
    ...
    f = FeedHandler()
    f.add_feed(Bybit(channels=[FUNDING, L2_BOOK], symbols=['BTC-USDT-PERP'], callbacks={FUNDING: FundingQuest(host=QUEST_HOST, port=QUEST_PORT), L2_BOOK: BookQuest(host=QUEST_HOST, port=QUEST_PORT)}))
