...
def main():
    ...
    f.add_feed(BITCOINCOM, channels=[CANDLES], symbols=['TRX-USDT'], callbacks={CANDLES: candles_callback})
    f.add_feed(HITBTC, channels=[CANDLES], symbols=['NEO-USDT'], callbacks={CANDLES: candles_callback})
