...
from cryptofeed.exchanges import Bitmex, Coinbase, Bitfinex, Poloniex, Gemini, HitBTC, Bitstamp, Kraken, Binance, EXX, Huobi, HuobiUS, OKCoin, OKEx, Coinbene, HuobiDM
...
def main():
    ...
    f.add_feed(Coinbase(config={L2_BOOK: ['BTC-USD']}, callbacks={L2_BOOK: BookCallback(book, depth=1)}))
    ...
    """
    f.add_feed(Bitmex(max_depth=2, pairs=['XBTUSD'], channels=[L2_BOOK], callbacks={L2_BOOK: BookCallback(book)}))
    """
