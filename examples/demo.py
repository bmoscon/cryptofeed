...
from cryptofeed.defines import BALANCES, CANDLES, BID, ASK, BLOCKCHAIN, FUNDING, GEMINI, L2_BOOK, L3_BOOK, LIQUIDATIONS, OPEN_INTEREST, PERPETUAL, TICKER, TRADES, INDEX
...
def main():
    ...
    f.add_feed(BitDotCom(config="config.yaml", sandbox=True, symbols=['BTC-USD-PERP'], channels=[BALANCES], callbacks={}))
