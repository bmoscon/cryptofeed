...
def main():
    ...
    f.add_feed(
        Bequant(
            symbols=["BTC-USDT"],
            channels=[L2_BOOK],
            callbacks={L2_BOOK: book, TRADES: trade, TICKER: ticker, CANDLES: candle_callback},
        )
    )
    ...
    f.add_feed(
        Binance(
            symbols=pairs,
            channels=[L2_BOOK],
            callbacks={L2_BOOK: book, CANDLES: candle_callback, TRADES: trade, TICKER: ticker},
        )
    )
    ...
    f.add_feed(
        BinanceFutures(
            ...
            callbacks={TRADES: trade, OPEN_INTEREST: oi, FUNDING: funding, LIQUIDATIONS: liquidations},
        )
    )
    f.add_feed(
        BinanceUS(symbols=BinanceUS.symbols()[:2], channels=[TRADES, L2_BOOK], callbacks={L2_BOOK: book, TRADES: trade})
    )
    f.add_feed(
        Bitfinex(symbols=["BTC-USDT"], channels=[L3_BOOK], callbacks={L3_BOOK: book, TICKER: ticker, TRADES: trade})
    )
    f.add_feed(
        Bitflyer(
            symbols=["BTC-JPY"],
    ...
    f.add_feed(
        Coinbase(
            subscription={L2_BOOK: ["BTC-USD"], TRADES: ["BTC-USD"], TICKER: ["BTC-USD"]},
    ...
    f.add_feed(
        Gateio(
            ...
            callbacks={CANDLES: candle_callback, L2_BOOK: book, TRADES: trade, TICKER: ticker},
        )
    )
    f.add_feed(
        GEMINI,
    ...
    f.add_feed(
        HuobiDM(
            subscription={L2_BOOK: HuobiDM.symbols()[:2], TRADES: HuobiDM.symbols()[:10]},
            callbacks={TRADES: trade, L2_BOOK: book},
        )
    )
    ...
    f.add_feed(
        KrakenFutures(
            ...
            callbacks={L2_BOOK: book, FUNDING: funding, OPEN_INTEREST: oi, TRADES: trade, TICKER: ticker},
        )
    )
    f.add_feed(
        Kraken(
            ...
            subscription={L2_BOOK: ["BTC-USD"], TRADES: ["BTC-USD"], CANDLES: ["BTC-USD"], TICKER: ["ETH-USD"]},
            callbacks={L2_BOOK: book, CANDLES: candle_callback, TRADES: trade, TICKER: ticker},
        )
    )
    f.add_feed(
    ...
    f.add_feed(
        OKCoin(
            ...
            callbacks={L2_BOOK: book, TICKER: ticker, TRADES: trade, CANDLES: candle_callback},
        )
    )
    f.add_feed(
        Phemex(
    ...
    f.add_feed(
        Poloniex(subscription={TRADES: ["DOGE-BTC"], L2_BOOK: ["LTC-BTC"]}, callbacks={TRADES: trade, L2_BOOK: book})
    )
    f.add_feed(
        Probit(subscription={TRADES: ["BTC-USDT"], L2_BOOK: ["BTC-USDT"]}, callbacks={TRADES: trade, L2_BOOK: book})
    )
    f.add_feed(
        Upbit(subscription={TRADES: ["BTC-USDT"], L2_BOOK: ["BTC-USDT"]}, callbacks={TRADES: trade, L2_BOOK: book})
    )
    f.add_feed(
        CryptoDotCom(
            symbols=["BTC-USDT"],
            channels=[L2_BOOK, TICKER, CANDLES, TRADES],
            callbacks={TRADES: trade, CANDLES: candle_callback, TICKER: ticker, L2_BOOK: book},
        )
    )
    f.add_feed(
        Delta(
    ...
    f.add_feed(
        Bitget(
            ...
            callbacks={CANDLES: candle_callback, TRADES: trade, L2_BOOK: book, TICKER: ticker},
        )
    )
    f.add_feed(
        IndependentReserve(symbols=["BTC-USD"], channels=[L3_BOOK, TRADES], callbacks={TRADES: trade, L3_BOOK: book})
    )
